defmodule Slidething.Image.Provider.Mock do
  ...
  @stub_png <<137, 80, 78, 71, 13, 10, 26, 10, 0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0, 1, 0, 0, 0, 1,
  ...
  def generate(_model, prompt, aspect_ratio) do
    Logger.debug("[Image.Mock] generate prompt=#{String.slice(prompt, 0, 40)} aspect=#{aspect_ratio}")
